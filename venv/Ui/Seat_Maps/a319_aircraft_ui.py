...
class SeatMap319(SeatMap):
    """A class representing a customized seat map for a specific aircraft model layout (Airbus A319-100)."""

    def __init__(self, master, passenger_id, flight_id):
        """Initialize the SeatMap319 object.
    ...
    def setup_layout(self):
        ...
        for i in range(10, 14):
            seat_row_number_label1 = tk.Label(self.seats_frame, text=i - 4)
            seat_row_number_label1.grid(row=3, column=i)

            self.economy_seat(grid_row=4, grid_column=i, aisle="a", seat_number=i - 4)
            self.economy_seat(grid_row=5, grid_column=i, aisle="b", seat_number=i - 4)
            self.economy_seat(grid_row=6, grid_column=i, aisle="c", seat_number=i - 4)
            self.economy_seat(grid_row=8, grid_column=i, aisle="d", seat_number=i - 4)
            self.economy_seat(grid_row=9, grid_column=i, aisle="e", seat_number=i - 4)
            self.economy_seat(grid_row=10, grid_column=i, aisle="f", seat_number=i - 4)

            seat_row_number_label2 = tk.Label(self.seats_frame, text=i - 4)
            seat_row_number_label2.grid(row=11, column=i)

        # Add empty labels for space without seats (overwing exit)
            label_empty_business = tk.Label(self.seats_frame, text="")
            label_empty_business.grid(row=4, column=14, padx=4, pady=4)

        # Add labels for second section of seat row numbers and economy class seats
        for i in range(15, 27):
            seat_row_number_label1 = tk.Label(self.seats_frame, text=i - 5)
            seat_row_number_label1.grid(row=3, column=i)

            self.economy_seat(grid_row=4, grid_column=i, aisle="a", seat_number=i - 5)
            self.economy_seat(grid_row=5, grid_column=i, aisle="b", seat_number=i - 5)
            self.economy_seat(grid_row=6, grid_column=i, aisle="c", seat_number=i - 5)
            self.economy_seat(grid_row=8, grid_column=i, aisle="d", seat_number=i - 5)
            self.economy_seat(grid_row=9, grid_column=i, aisle="e", seat_number=i - 5)
            self.economy_seat(grid_row=10, grid_column=i, aisle="f", seat_number=i - 5)

            seat_row_number_label2 = tk.Label(self.seats_frame, text=i - 5)
            seat_row_number_label2.grid(row=11, column=i)
