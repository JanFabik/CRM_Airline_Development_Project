...
class SeatMapSU9(SeatMap):
    """A class representing a customized seat map for a specific aircraft model layout (Sukhoi Superjet-100)."""

    def __init__(self, master, passenger_id, flight_id):
        """Initialize the SeatMapSU9 object.
    ...
    def setup_layout(self):
        ...
        # Add labels for aisle 1
        label_aisle1 = tk.Label(self.seats_frame, text="")
        label_aisle1.grid(row=2, column=0, padx=4, pady=4)

        # Add labels for aisle 2
        label_aisle2 = tk.Label(self.seats_frame, text="")
        label_aisle2.grid(row=6, column=0, padx=4, pady=4)
        ...
        for i in range(4, 21):
            ...
            self.economy_seat(grid_row=4, grid_column=i, aisle="d", seat_number=i)
            self.economy_seat(grid_row=5, grid_column=i, aisle="e", seat_number=i)
